...
public class SignupThree extends JFrame implements ActionListener{
    ...
    SignupThree(String formno) {
        ...
        JLabel num = new JLabel("XXXX-XXXX-XXXX-4134");
        num.setFont(new Font("Raleway", Font.BOLD,16));
        num.setBounds(330,303,300,30);
        add(num);
        ...
        c7 = new JCheckBox("I hereby declare that the above entered details are correct to my knowledge");
